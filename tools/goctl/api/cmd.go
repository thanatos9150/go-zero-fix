...
import (
	...
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/apigen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/dartgen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/docgen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/format"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/gogen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/javagen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/ktgen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/new"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/swagger"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/tsgen"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/api/validate"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/config"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/internal/cobrax"
	"github.com/thanatos9150/go-zero-fix/tools/goctl/plugin"
)
